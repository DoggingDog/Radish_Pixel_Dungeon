...
//			case LEGENDS_STORY:                return new RegionLorePage.LengStory();
		}
	}
	...
	public static class LengStory extends DocumentPage {
		{
			image = ItemSpriteSheet.LENGDS_PAGE;
		}

		@Override
		public Document document() {
			return Document.LEGENDS_STORY;
		}
	}
