...
public enum Catalog {
	...
	static {
		...
		ARMOR.addItems(Generator.Category.ARM_T1.classes);
		ARMOR.addItems(Generator.Category.ARM_T2.classes);
		ARMOR.addItems(Generator.Category.ARM_T3.classes);
		ARMOR.addItems(Generator.Category.ARM_T4.classes);
		ARMOR.addItems(Generator.Category.ARM_T5.classes);
		ARMOR.addItems(Generator.Category.ARM_T5_NATURE.classes);
